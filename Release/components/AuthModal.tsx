...
const AuthModal: React.FC<AuthModalProps> = ({ onLogin, onRegister, loading, error }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
       <div className="bg-slate-900 border border-indigo-500/30 rounded-2xl p-8 max-w-md w-full shadow-[0_0_50px_rgba(79,70,229,0.2)] relative overflow-hidden animate-in fade-in zoom-in-95 duration-300">
